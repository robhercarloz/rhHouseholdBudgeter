...
namespace rhHouseholdBudgeter.Controllers
{
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BudgetId,Created,BudgetName,TargetAmount,CurrentAmount")] BudgetItem budgetItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BudgetId,Created,BudgetName,TargetAmount,CurrentAmount")] BudgetItem budgetItem)
        {
            if (ModelState.IsValid)
            {
